...
#if 1	// DSD Support // Enable on Bata 6 for IODATA	// Paul Liao inXtron 20131230
			while(off < len - 8 && len > off)
#else	// Old Version
			while(off < len - 8)
#endif
			{
...
#if 1	// DSD Support	// Disable on Bata 6  for IODATA	// Paul Liao 20131230
		// DSD Support	// Enable on Bata 7	for IODATA	// Paul Liao inXtron 20140227
